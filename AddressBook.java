...
public class AddressBook {
    ...
    private static File file = new File("C:\\Users\\Ankita\\eclipse-workspace\\Day-27\\ContactFile.txt");
    ...
    public static void printData() throws IOException {
		try {
			Files.lines(new File("C:\\Users\\Ankita\\eclipse-workspace\\Day-27\\ContactFile.txt").toPath())
